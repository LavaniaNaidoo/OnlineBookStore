        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Order SuccessFully Placed! It will be collected on Delivery! ");
                    </script>
                 <?php                  
                  }
	        ...
	        if(!isset($_SESSION['user']))
	          {
	            ...
	            echo' <li> <a href="destroy.php" class="btn btn-lg" style="color:#000000;"> Logout  </li> </a>';
	        ?>
...
echo '<div class="container-fluid" id="cart">
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#000000;text-transform:uppercase;"> Your Cart: </h2>
           </div>
        </div>';
	if(isset($_SESSION['user']))
	    {   
                ...
                {    $i=1;
                     ...
                     {       $path = "img/books/".$row['PID'].".jpg";
                             ...
                             if($j%2==0)
                                 echo '<div class="row">'; 
                                 echo '                
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-'.$offset.' col-md-4 col-md-offset-'.$offset.' col-lg-4 col-lg-offset-'.$offset.' text-center" style="color:#000000;font-weight:800;">
                        ...
                        echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#000000;font-weight:bold;">&nbsp &nbsp &nbsp &nbspCart Is Empty! </span>
                             </div>
                         </div>
                         <br>
                         <div class="row">
